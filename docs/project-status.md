...
| Keyboard, copy, reset, print, layout                       | Tab order item → shipping → tax; copied text names item, shipping, and tax; reset clears both; no overflow at 360 px; no console errors |
| Embeds at 360 px                                           | Depop 1,891, Poshmark 1,571, Mercari 1,721, Facebook Marketplace 1,887 px with an error showing                                         |
