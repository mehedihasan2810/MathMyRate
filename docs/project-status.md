...
The brand mark (added 2026-09-15) is a moss rounded tile with a paper percent
slash and two clay dots, drawn from the same palette tokens as the site. It
...
`#426455`, four icon entries). All are generated by
