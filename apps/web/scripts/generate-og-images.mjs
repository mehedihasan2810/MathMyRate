...
const cards = [
  ...
  {
    file: "depop",
    eyebrow: "Resale fees / Depop",
    accent: palette.navy,
    title: "Depop fee calculator",
    description: "No selling fee: what 3.3% + 45¢ processing leaves you.",
    path: "/fees/depop-fee-calculator/",
  },
  {
    file: "poshmark",
    eyebrow: "Resale fees / Poshmark",
    accent: palette.gold,
    title: "Poshmark fee calculator",
    description: "$2.95 under $15, 20% from $15, and what you earn.",
    path: "/fees/poshmark-fee-calculator/",
  },
  {
    file: "mercari",
    eyebrow: "Resale fees / Mercari",
    accent: palette.navy,
    title: "Mercari fee calculator",
    description: "The 10% selling fee on the item and buyer-paid shipping.",
    path: "/fees/mercari-fee-calculator/",
  },
  {
    file: "facebook-marketplace",
    eyebrow: "Resale fees / Facebook Marketplace",
    accent: palette.gold,
    title: "Facebook Marketplace fee calculator",
    description: "The 10% selling fee on shipped orders, at least 80¢.",
