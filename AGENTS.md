...
- Public routes are `/`; `/freelance/` plus the hourly rate, project rate, retainer, markup and margin, salary to hourly, early payment discount, rate increase, and 1099 vs W-2 rate calculators; `/fees/` plus the Stripe, PayPal, Square, Etsy, eBay, Depop, Poshmark, Mercari, Facebook Marketplace, Cash App, Venmo, Upwork, Fiverr, Kickstarter, Indiegogo, Patreon, Ko-fi, Substack, Payhip, Podia, Whop, Skool, Teachable, Gumroad, and Lemon Squeezy calculators, the KDP royalty calculator, the payout fee calculator, the `/fees/stripe-vs-paypal-fees/`, `/fees/gumroad-vs-lemon-squeezy-fees/`, `/fees/upwork-vs-fiverr-fees/`, `/fees/patreon-vs-ko-fi-fees/`, `/fees/substack-vs-patreon-fees/`, `/fees/payhip-vs-gumroad-fees/`, `/fees/kickstarter-vs-indiegogo-fees/`, `/fees/creator-platform-fees/`, and `/fees/teachable-vs-podia-fees/` comparisons, and `/fees/digital-product-platform-fees/`; `/guides/` and its guides; noindex `/embed/` copies of every calculator; `/methodology/`, `/changelog/`, `/about/`, `/privacy/`, `/terms/`; and a 404 page for unknown routes. Tools are free;
